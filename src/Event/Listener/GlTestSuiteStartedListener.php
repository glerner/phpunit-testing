...
class GlTestSuiteStartedListener implements TestSuiteStartedSubscriberInterface
{
    ...
    public function __construct(string $logDir)
    {
        ...
        if ($this->debug) {
            ...
            if (!file_exists($this->logFile) || filesize($this->logFile) === 0) {
                 ...
                 file_put_contents($this->logFile, sprintf("--- Listener GlTestSuiteStartedListener activated at %s ---\n", date('Y-m-d H:i:s')), FILE_APPEND);
            }
        }
    }
